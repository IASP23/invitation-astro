...
}, "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/layouts/Layout.astro", void 0);
...
}, "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/components/Form.astro", void 0);
...
Ver ubicación</a></div>`;
}, "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/components/CardHorario.astro", void 0);
...
}, "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/components/Temporizer.astro", void 0);

const $$Astro$1 = createAstro();
const $$Gallery = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Gallery;
  return renderTemplate`${maybeRenderHead()}<div class="p-2 grid grid-cols-3" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az><img src="./test.webp" loading="lazy" width="896" height="896" alt="" data-astro-cid-ihllb3az></div>`;
}, "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/components/Gallery.astro", void 0);

const $$Astro = createAstro();
const $$InvitationDavid = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$InvitationDavid;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Boda" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<main class="relative flex justify-center text-white h-[100vh]"><img src="/main_photo.webp" alt="Imagen" class="w-full h-full object-cover" height="912" width="1368"><h1 class="py-10 absolute text-4xl md:text-6xl uppercase">Nos casamos</h1><h2 class="absolute py-56 text-3xl">Alice & David</h2></main><div class="py-5 flex flex-col items-center justify-center gap-3 text-center"><div class="temporizer"><h2 class="text-4xl">Estás invitado</h2><p>Queremos que seas parte de este momento tal especial !</p></div><div class="timer">${renderComponent($$result2, "Temporizer", $$Temporizer, {})}${renderComponent($$result2, "Timer", $$Timer, {})}</div><div class="cards"><div class="flex justify-center items-center"><img src="./anillo2.png" alt="vestido" width="32px" height="32px"></div><h2 class="text-4xl">Ceremónia</h2>${renderComponent($$result2, "CardHorario", $$CardHorario, { "oclock": "17:00", "place": "Iglesia San Martin de Porres", "street": "Eduardo Morley y George Davis", "href": "https://goo.gl/maps/p242XZfmz7vhqQeh8" })}<h2 class="text-4xl">Celebración</h2>${renderComponent($$result2, "CardHorario", $$CardHorario, { "oclock": "17:00", "place": "Iglesia San Martin de Porres", "street": "Eduardo Morley y George Davis", "href": "https://goo.gl/maps/p242XZfmz7vhqQeh8" })}</div><div class="dressCode py-10"><h2 class="text-4xl">Código de Vestimenta</h2><p>Formal - No niños</p></div><div class="gallery"><h2 class="text-4xl">Nosotros</h2>${renderComponent($$result2, "Gallery", $$Gallery, {})}</div><div class="">${renderComponent($$result2, "Form", $$Form, {})}</div><footer class="py-10"><h1 class="m-auto text-6xl">Te esperamos</h1><h2 class="text-4xl">Alice & David</h2></footer></div>` })}`;
}, "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/pages/invitation-David.astro", void 0);

const $$file = "C:/Users/ismae/Downloads/Projects/Invitation-astro/src/pages/invitation-David.astro";
